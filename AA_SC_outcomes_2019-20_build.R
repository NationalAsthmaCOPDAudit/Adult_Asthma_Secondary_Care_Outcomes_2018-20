...
filename <- "C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Analysis/Logs/AA_SC_Outcomes_2019-20_build_log"
filedate <- Sys.Date()
...
# library(chron)
# 
# dat_old <- readRDS("C:/Users/aadamson/Documents/Adult Asthma/Secondary Care Clinical 2018-2019/tidyData/RDS files/clean_dat_from_2020-01-29_script.RDS")
# 
# dat_old <- dat_old %>% mutate(across(ends_with("_date"), ~as.Date(.)))
# dat_old <- dat_old %>% mutate(across(ends_with("_DT"), ~as.POSIXct(.)))

# Now things are back to how they were.

dat <- readRDS("C:/Users/aadamson/Documents/Adult Asthma/SCC 2019-2020/Data/tidyData/AA_SCC_2019-20_clean_data_2020-10-07.RDS")

# checkSame(dat, dat_old)

# quite different but we cna worry about that when we combine them.
...
HES1_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/FILE0144604_NIC357479_HES_APC_201899.txt",
...
HES2_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/FILE0144605_NIC357479_HES_APC_201999.txt",
                     sep = "|", stringsAsFactors = FALSE)

# write.csv(HES2, "D:/Alex/COPD/SC Outcomes 2018/data/rawData/viewing/HES2.csv", row.names = FALSE) 


ONS1_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/FILE0144220_NIC357479_ONS_MORTALITY_RESUPPLY.txt", 
                 sep = "|", stringsAsFactors = FALSE)

ONS2_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/FILE0157734_NIC357479_CIVREG_MORT_WALES_ADDITIONAL.txt", 
                 sep = "|", stringsAsFactors = FALSE)

# ONS1_old$DOD <- as.Date(ONS_old$DOD)


# New...

HES1 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161076_NIC357479_HES_APC_E_201999.txt",
                     sep = "|", stringsAsFactors = FALSE)
...
HES2 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161077_NIC357479_HES_APC_E_202099.txt",
                 sep = "|", stringsAsFactors = FALSE)


checkSame(HES2, HES1) # identical

HES3 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161078_NIC357479_HES_APC_W_201999.txt",
                 sep = "|", stringsAsFactors = FALSE)

HES4 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161079_NIC357479_HES_APC_W_202099.txt",
                 sep = "|", stringsAsFactors = FALSE)

HES5 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161080_NIC357479_HES_APC_W_201899.txt",
                 sep = "|", stringsAsFactors = FALSE)


checkSame(HES2, HES3) # identical
checkSame(HES2, HES4) # identical
checkSame(HES2, HES5) # identical
...
ONS1 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161074_NIC357479_CIVREG_DEATHS_E.txt",
                 sep = "|", stringsAsFactors = FALSE)
...
ONS3 <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/FILE0161075_NIC357479_CIVREG_DEATHS_W.txt",
                 sep = "|", stringsAsFactors = FALSE)


checkSame(ONS1, ONS1_old) # need to change the colnames to match
...
colnames(ONS3) <- toupper(colnames(ONS3))
...
NRS_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/nrsdeaths-AA-201811-201903-v102a.csv",
                    sep = ",", stringsAsFactors = FALSE)

NRS <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/nrsdeaths-AA-201904-202003-v100.csv",
                    sep = ",", stringsAsFactors = FALSE)
...
SMR_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/smr01-AA-201811-201903-v102a.csv", 
                    sep = ",", stringsAsFactors = FALSE)

SMR <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/smr01-AA-201904-202003-v100.csv", 
                sep = ",", stringsAsFactors = FALSE)
...
PEDW_old <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2018-19/Data/rawData/Request_31048_NACAP_Cohort1.csv",
                     stringsAsFactors = FALSE)

PEDW <- read.csv("C:/Users/aadamson/Documents/Adult Asthma/SC_outcomes_2019-20/Data/rawData/Request_31048_NACAP_Cohort2.csv",
                 stringsAsFactors = FALSE)
...
# STUDYID and PseudoAuditId are in the new one, PatientID and PseudoPatientId are in the old one

dat %>% filter(patient_ID %in% PEDW$STUDYID) %>% nrow() # wrongly linked again
dat %>% filter(study_ID %in% PEDW$STUDYID) %>% nrow() # linked on study_ID

dat %>% filter(country == "Wales") %>% select(patient_ID) %>% unique() %>% nrow()

dat %>% filter(patient_ID %in% PEDW_old$STUDYID) %>% nrow() # wrongly linked again
dat %>% filter(study_ID %in% PEDW_old$STUDYID) %>% nrow() # linked on study_ID
...
# New: C:/Users/aadamson/Documents/COPD/SC_outcomes_2018-19/Data/rawData/Request_31488_NACAP_COPD_Cohort1.csv
# Old: C:/Users/aadamson/Documents/COPD/SC Outcomes 2018/data/rawData/COPD_outcomes_PEDW_2018_30266_no_pw_v2_RDS_format.RDS
...
datid <- dat %>% select(patient_ID) %>% pull() %>% as.character() %>% unique()
HESid <- HES %>% select(STUDY_ID) %>% pull() %>% as.character() %>% unique()
PEDWid <- PEDW %>% select(STUDYID1) %>% pull() %>% as.character() %>% unique()
SMRid <- SMR %>% select(PID) %>% pull() %>% as.character() %>% unique()


HESPEDWSMRids <- unique(c(HESid, PEDWid, SMRid))

length(HESPEDWSMRids)
...
nlc("Total unique admissions in PEDW/HES:")
PEDW %>% filter(CountAdmittingEpisode == 1) %>% nrow()
...
dat %>% filter(!(patient_ID %in% HESPEDWSMRids)) %>% nrow() %>% nlc()
...
# Seems like it's worked! What a great function!
...
nlc("Because we expect everyone to have had at least asthma, we will group CCI scores of 0 and 1 together")
